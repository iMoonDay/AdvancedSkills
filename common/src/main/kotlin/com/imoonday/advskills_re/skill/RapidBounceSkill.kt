...
class RapidBounceSkill : BounceSkill(
    Settings(
        id = "rapid_bounce",
        cooldown = 4,
    ...
    override fun onDamaged(
        ...
        player.bounce(attacker, amount)

        val reduction = getFloatParam(PARAM_DAMAGE_REDUCTION, player, DEFAULT_DAMAGE_REDUCTION, max = 1f)
    ...
    companion object {
        ...
        // Default Values
        private const val DEFAULT_DAMAGE_REDUCTION = 0.5f
